...
Mobile optimization validation: a 390×844 headless Chromium screenshot confirmed the revised hero uses a smaller Greek headline, tighter supporting copy, compact CTAs, hidden mobile navigation links, and a simplified logo-only mobile header. The hero headline, supporting text, and primary actions are visible above the fold in the tested mobile viewport. The development preview banner appears only in the preview environment and is not part of the site design.
